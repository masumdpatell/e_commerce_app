...
class SpotPageBody extends StatefulWidget {
  const SpotPageBody({Key? key}) : super(key: key);

  @override
  State<SpotPageBody> createState() => _SpotPageBodyState();
}

class _SpotPageBodyState extends State<SpotPageBody> {
      ...
      children: [
        Padding(
          padding: EdgeInsets.only(
              left: Dimensions.all1 * 15,
              right: Dimensions.all1 * 15,
              top: Dimensions.all1 * 20,
              bottom: Dimensions.all1 * 20),
          child: Row(
        ...
        Padding(
          ...
          child:
            ...
            return SmoothPageIndicator(
              ...
              effect: WormEffect(
                dotHeight: Dimensions.all1 * 10,
                dotWidth: Dimensions.all1 * 10,
        ...
        Container(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Container(
              margin: EdgeInsets.only(bottom: Dimensions.all1 * 3),
              child: BigText(
                text: ".",
                color: black26,
              ),
            ...
            Container(
                margin: EdgeInsets.only(bottom: Dimensions.all1 * 2),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            height: Dimensions.all1 * 15,
                            width: Dimensions.all1 * 100,
                            child: Expanded(
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, position) {
                                    return Container(
                                      margin: EdgeInsets.only(
                                          right: Dimensions.all1 * 5),
                                      height: Dimensions.all1 * 15,
                                      width: Dimensions.all1 * 15,
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          fit: BoxFit.cover,
                                          image: NetworkImage(
